     ...
     <input type="hidden" name="type" value="Thesis">
      ...
      <tr>
        ...
        <tr>
          ...
          <td>
            <input type="text"  name="university" value="{{publication.get('university','')}}"/>
          </td>
          ...
          <td>
            <input type="text"  name="academic_year" value="{{publication.get('academic_year','')}}"/>
          </td>
          </td>
        ...
        <tr>
           ...
           <td>
             <select name="project" id="projects_th" multiple="multiple" style="width:370px">
       ...
       <tr>
        ...
        <td> &nbsp; </td>
        <td>
         <button type="submit" name="add thesis" >add thesis</button>
        </td>
        </tr>
