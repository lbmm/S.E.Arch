...
$(document).ready(function(){
 $("#projects_missions_cp").multiselect().multiselectfilter( {
    ...
    $("#contract_cp").multiselect().multiselectfilter( {
   ...
   $("#authors_asi_cp").multiselect().multiselectfilter( {
      ...
      <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          <select id='authors_asi_cp' name="asi_authors" style="width:370px" multiple="multiple" >
        ...
        <tr>
          ...
          <td>
            <input type="text" name="eventname" size="80" value="{{publication.get('eventname', '')}}">
          </td>
         </tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="booktitle" size="80"  value="{{publication.get('booktitle','')}}">
          </td>
         </tr>
         ...
         <tr>
          ...
          <td>
            <input type="text" name="publisher" size="80" value="{{publication.get('publisher', '')}}">
          </td>
         </tr>
       ...
       <tr>
           ...
           <td>
             <select id='projects_cp' name="project"   style="width:370px" multiple="multiple">
        ...
        <tr>
          ...
          <td >
            <select name="contracts"  id="contract_cp" multiple="multiple" style="width:370px">
        ...
        <td> &nbsp; </td>
        <td>
         <button type="submit" name="update publication" >update publication</button>
        </td>
        </tr>
