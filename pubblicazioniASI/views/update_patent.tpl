...
$(document).ready(function(){
 $("#projects_missions_pa").multiselect().multiselectfilter( {

       autoReset:true,
       optGroupCollapsible:true

   } );
     $("#projects_pa").multiselect().multiselectfilter( {
  ...
  $("#contract_pa").multiselect().multiselectfilter( {
   ...
   $("#authors_asi_pa").multiselect().multiselectfilter( {
     ...
     <input type="hidden" name="_id" value="{{publication['_id']}}">
      ...
      <tr>
        ...
        <tr>
          ...
          <select id='authors_asi_pa' name="asi_authors" style="width:370px" multiple="multiple" >
	    ...
	    {{utilities_values['errors']['start_date_error']}}
         ...
         <tr>
          ...
          <td>
            <input type="text" name="code"  value="{{publication.get('code', '')}}" >
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input type="url"  size="80" name="link" value="{{publication.get('link', '')}}">
          </td>
          <td class="error">
        ...
        <tr>
           <td > Area/Category </td>
           <td>
            <select id='projects_missions_pa' name="project_mission" style="width:370px"  multiple="multiple">
        ...
        <tr>
           ...
           <td>
             <select id='projects_pa' name="project"   style="width:370px" multiple="multiple">
        ...
        <tr>
          ...
          <td >
            <select name="contracts"  id="contract_pa" multiple="multiple" style="width:370px">
        ...
        <td> &nbsp; </td>
        <td>
         <button type="submit" name="update patent" >update patent</button>
        </td>
        </tr>
