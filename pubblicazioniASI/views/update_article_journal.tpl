...
$(document).ready(function(){
 $("#projects_missions_aj").multiselect().multiselectfilter( {
   ...
   $("#authors_asi_aj").multiselect().multiselectfilter( {
     ...
     <input type="hidden" name="_id" value="{{publication['_id']}}">
      ...
      <tr>
	    ...
	    {{utilities_values['errors']['general']}}
         ...
         <tr>
          ...
          <td>
            ...
            <textarea rows="2" cols="50" name="title" autofocus required>{{publication.get('title', '')}}</textarea> *
        ...
        <tr>
          ...
          <td>
            <textarea rows="2" cols="50" name="author" required>{{publication.get('author', '')}}</textarea> *
          </td>
         <td class="error">
         ...
         <tr>
          ...
          <select id='authors_asi_aj' name="asi_authors" style="width:370px" multiple="multiple" >
        ...
        <tr>
          ...
          <td>
            <input type="text" name="journal" size="60"  value="{{publication.get('journal', '')}}">
          </td>
          <td class="error">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="number"  value="{{publication.get('number', '')}}">
          </td>
        </tr>
        ...
        <tr>
           ...
           <td>
             <select id='projects_aj' name="project"   style="width:370px" multiple="multiple">
