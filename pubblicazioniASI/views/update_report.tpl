...
$(document).ready(function(){
 ...
 $("#projects_rp").multiselect().multiselectfilter( {
  ...
  $("#contract_rp").multiselect().multiselectfilter( {
   ...
   $("#authors_asi_rp").multiselect().multiselectfilter( {
    ...
    <form method="post" action="/update_publication">
     ...
     <input type="hidden" name="_id" value="{{publication['_id']}}">
      ...
      <tr>
          ...
          <select id='authors_asi_rp' name="asi_authors" style="width:370px" multiple="multiple" >
        ...
        <tr>
           ...
           <td>
             <select id='projects_rp' name="project"   style="width:370px" multiple="multiple">
        ...
        <td> &nbsp; </td>
        <td>
         <button type="submit" name="update report" >update report</button>
        </td>
        </tr>
