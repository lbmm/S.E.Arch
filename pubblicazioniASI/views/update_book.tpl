...
$(document).ready(function(){
 $("#projects_missions_book").multiselect().multiselectfilter( {
   ...
   $("#authors_asi_book").multiselect().multiselectfilter( {
     ...
     <input type="hidden" name="_id" value="{{publication['_id']}}">
      ...
      <tr>
        ...
        <tr>
          ...
          <select id='authors_asi_book' name="asi_authors" style="width:370px" multiple="multiple" >
        ...
        <tr>
          ...
          <td>
            <input type="text" name="booktitle"  value="{{publication.get('booktitle', '')}}">
          </td>
        ...
        <tr>
          ...
          <td>
            <input type="text"  name="series" size="60" value="{{publication.get('series','')}}">
          </td>
        </tr>
        ...
        <tr>
           ...
           <td>
             <select id='projects_book' name="project"   style="width:370px" multiple="multiple">
