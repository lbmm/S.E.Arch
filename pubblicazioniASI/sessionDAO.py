...
class SessionDAO:
    ...
    def start_session(self, username,admin):

        session_id = self.get_random_str(32)
        session = {'username': username, 'admin':  admin, '_id': session_id}
    ...
    def get_username(self, session_id):
     ...
     # get the property of the super user of the current session, or None if the session is not valid
    def get_admin(self, session_id):
